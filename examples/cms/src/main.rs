...
/// tailed by external tooling (e.g. an rngo channel with no effects writing to it, used as an
/// output source). The returned guard must stay alive for the process lifetime, or the
